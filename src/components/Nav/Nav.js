      ...
      <div className='nav-container'>
        ...
        <div className='inner-container'>
          ...
          <div className={'nav-body ' + navStyles}>
            <ul>
              <NavItem identifier="Logout" icon={<FaArrowLeft  />} label="Logout" onClick={() => navHandler("Logout")} />
              <NavItem identifier="Account" icon={<RiUserSettingsLine />} label="Account options" onClick={() => navHandler("Account")} />
              <NavItem identifier="adminDash" icon={<IoPeopleCircleOutline />} label="Admin Dashboard" onClick={() => navHandler("adminDash")} />
            </ul>
          </div>
        </div>
      </div>
