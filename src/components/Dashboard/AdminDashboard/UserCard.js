  ...
  const collapsed =
    <div className={
      ...
      <div className="card-content">
        ...
        {user.simpaticoMatch ? <button onClick={e => removeMatch(e, user)} className='card-btn'>Remove match</button> : <button onClick={matchInputDisplaySwitch} className='card-btn'>Matching options</button>}
