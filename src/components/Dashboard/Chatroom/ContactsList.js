      ...
      <div className="contacts-list">
        ...
        <div className="contact" >
          ...
          <div className="contact-body">
            ...
            <p>{contact.residence}, {calculateAge(contact.birthDate)}</p>
            <div className='convo-starter'>
            <h6>You have an active conversation with {contact.displayName}</h6>
            <RxCaretRight />
            </div>
          </div>
        </div>
        <div className="contact" >
          <div className='img-container'>
            <img className='profile-image' alt={`Profile of ${contact.displayName}`} src="https://as1.ftcdn.net/v2/jpg/05/61/85/98/1000_F_561859826_zgMyHNg9tYqL7vhzQyCbX51zwruqcwV6.jpg" />
          </div>
          <div className="contact-body">
            <h5>Joe Miller </h5>
